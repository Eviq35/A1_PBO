...
//                Petarung b = new Petarung (2, "Conor", "KickBoxing", "Menengah");
                petarung a = new petarung(1, "conor", "Kickboxing", "Menengah");
                
                khabib b = new khabib(2,"Khabib", "Gulat", "Menengah");
                
                Tyson c = new Tyson(3, "Tyson", "Boxing", "Berat");
                
                pertandingan1 pertandingan = new pertandingan1("London", "07:00 PM", "khabib", "conor", "beinSport");
                ConorMcgregor jadwal = new ConorMcgregor("Hawai", "08:00 PM", "Khabib", "TVONE");
                ...
                System.out.println("====================="); 
                System.out.println("Petarung Ke-" + 3);
                c.show();
